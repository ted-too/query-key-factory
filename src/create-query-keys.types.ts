...
export type AnyQueryFactoryOutputCallback = DynamicFactoryOutput<
  [string, ...any[]],
  DynamicKey
>;
...
export type QueryKeyFactoryResult<
  Key extends string,
  Schema extends QueryFactorySchema,
> = FactoryOutput<Key, Schema>;

export type AnyQueryKeyFactoryResult =
  | DefinitionKey<[string]>
  | QueryKeyFactoryResult<string, any>;
