    ...
    it("returns the expected types and shape", () => {
      ...
      expect(sut.prop).toHaveType<{
        ...
        _ctx: {
          ...
          nested3: { _def: readonly ["test", "prop", "nested3"] } & ((
            value: string
          ) => {
      ...
      expect(sut.prop).toHaveType<
        {
          ...
          _ctx: {
            nested1: {
              mutationKey: readonly ["test", "prop", string, "nested1"];
            };
            nested2: {
              _def: readonly ["test", "prop", string, "nested2"];
              mutationKey: readonly ["test", "prop", string, "nested2", string];
            };
            nested3: { _def: readonly ["test", "prop", string, "nested3"] } & ((
              nestedValue: string
            ) => {
