...
type MutationFactoryWithContextualMutationsSchema =
...
export type MutationFactorySchema = Record<
  string,
  MutationFactoryProperty | MutationDynamicKey
>;

type InvalidSchema<Schema extends MutationFactorySchema> = Omit<
  Schema,
  InternalKey
>;

export type ValidateFactory<Schema extends MutationFactorySchema> =
  Schema extends {
...
type MutationFactoryWithContextualQueriesOutput<
  ...
  ContextMutations extends
    Schema["contextMutations"] = Schema["contextMutations"],
  ComposedKey extends AnyMutableOrReadonlyArray = ComposeQueryKey<
    BaseKey,
    ExtractNullableKey<SchemaMutationKey>
  >,
...
type FactoryMutationOptionsWithContextualQueriesOutput<
  ...
  ContextMutations extends
    Schema["contextMutations"] = Schema["contextMutations"],
  Key extends AnyMutableOrReadonlyArray = ComposeQueryKey<
    BaseKey,
    ExtractNullableKey<SchemaQueryKey>
  >,
> = SchemaQueryKey extends null
...
> = ((
  ...
  ? Omit<
      MutationOptionsStruct<[...Keys, ...TupleResult], MutateFunction>,
      "mutationFn"
    >
  : Output extends DynamicMutationFactoryWithContextualMutationsSchema
    ? Omit<
        FactoryMutationOptionsWithContextualQueriesOutput<Keys, Output>,
        "_def"
      >
...
export type AnyMutationFactoryOutputCallback = DynamicMutationFactoryOutput<
  [string, ...any[]],
  MutationDynamicKey
>;
...
> = Property extends null
  ...
  : Property extends [...infer Result] | readonly [...infer Result]
    ? DefinitionKey<Keys> &
        Omit<
          MutationOptionsStruct<[...Keys, ...Result], MutateFunction>,
          "mutationFn"
        >
...
export type MutationKeyFactoryResult<
  Key extends string,
  Schema extends MutationFactorySchema,
> = MutationFactoryOutput<Key, Schema>;

export type AnyMutationKeyFactoryResult =
  | DefinitionKey<[string]>
  | MutationKeyFactoryResult<string, any>;
